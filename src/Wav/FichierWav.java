...
public class FichierWav {
    // Attributs
    private static FichierMidi fichierMidi;
    ...
    // Setters
    public static void setFichierMidi(FichierMidi fichierMidi) {
        FichierWav.fichierMidi = fichierMidi;
    }
