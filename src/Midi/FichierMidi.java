...
public class FichierMidi implements Extractable {
    ...
    public void extract() {
        try {
            ...
            System.out.println("Erreur lors de la lecture du fichier midi " + this.filePath +  " !");

            this.isLoaded = false;
        } catch (IOException e) {
            System.out.println("Erreur lors de la lecture du fichier " + this.filePath +  " !");

            this.isLoaded = false;
        }
        FichierWav.setFichierMidi(this);
    }
}
